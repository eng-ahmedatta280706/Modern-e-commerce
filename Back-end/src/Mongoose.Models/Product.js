...
productSchema.methods.decreaseStock = function (qty) {
  this.stock = Math.max(0, this.stock - qty);
  this.sold += qty;
};

productSchema.methods.restoreStock = function (qty) {
  this.stock += qty;
...
export const find = function (filter = {}) {
  return this.find(filter);
};

export const findOne = function (filter = {}) {
...
export const updateProductById = function (
  id,
  data,
  options = {}
) {
...
export const countProducts = function (filter = {}) {
