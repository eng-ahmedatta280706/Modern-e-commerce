import { createNotification as createNotificationModel } from '../Models/Notification.js';

const createNotification = async ({ recipient, type, title, message, link = '', data = {} }) => {
  try {
    return await createNotificationModel(recipient, type, title, message, link, data);
  } catch (err) {
...
export function notifyNewOrder(adminId, order) {
...
export function notifySellerNewOrder(sellerId, order, items) {
  return createNotification({
    recipient: sellerId,
    type: 'new_order',
...
export function notifyNewSeller(adminId, seller) {
  return createNotification({
    recipient: adminId,
    type: 'new_seller',
...
export function notifySellerApproved(sellerId) {
  return createNotification({
    recipient: sellerId,
...
export function notifySellerRejected(sellerId) {
  return createNotification({
    recipient: sellerId,
...
export function notifyLowStock(sellerId, product) {
  return createNotification({
    recipient: sellerId,
    type: 'low_stock',
...
export function notifyNewReview(sellerId, product, review) {
  return createNotification({
    recipient: sellerId,
    type: 'new_review',
    title: 'New Review',
