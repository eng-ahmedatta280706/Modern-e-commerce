              ...
              <li key={`${item.id}-${item.selectedColor}`} className="py-4 flex gap-3">
                ...
                <div className="flex flex-1 flex-col">
                  <div className="flex justify-between">
                    ...
                    <p className="text-sm font-medium ml-2 shrink-0">{formatPrice(item.price)}</p>
                  </div>
        ...
        cartItems.length > 0 && (
          <div className="border-t p-4">
            ...
            <div className="space-y-2">
              <Link
                to="/checkout"
                className="w-full bg-brand-600 text-white py-2.5 px-4 rounded-lg text-center block hover:bg-brand-700 transition-colors font-medium text-sm"
                onClick={onClose}
              >
                Checkout
              </Link>
